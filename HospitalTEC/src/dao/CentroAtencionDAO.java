...
public class CentroAtencionDAO extends ConexionMySQL {
    ...
    public boolean modificarCentreo(CentroDeAtencion centro) {
        ...
        String sql = "UPDATE CentroDeAtencion SET nombre =?, lugar =?, capPacientes=?, tipoCentro=? WHERE idCentroDeAtencion =? ";
    ...
    public String consultarCentro(int pId){
        ...
        ResultSet rs=null;
         ...
         try {
             ...
             while(rs.next())
             {  
            	  CentroDeAtencion centro = new CentroDeAtencion(rs.getString("nombre"), rs.getString("lugar"),rs.getInt("capPacientes"), rs.getString("tipoCentro"));
