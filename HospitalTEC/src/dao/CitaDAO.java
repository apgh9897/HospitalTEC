...
public class CitaDAO extends ConexionMySQL{
        ...
        ResultSet rs=null;
         ...
         try {
             ...
             while(rs.next())
             {
             	...
             	Paciente paciente = new Paciente(rs.getInt("cedula"),rs.getString("nombreCompleto"), rs.getString("fechaNacimiento"),
     ...
     * @throws SQLException
     */
    public String consultarCitaRangoFechasPaciente(int pCedula,String pFechaPiso, String pFechaTecho){
       String consulta="";
 	   PreparedStatement ps = null;
       ResultSet rs=null;
        Connection con = (Connection) conectar();
