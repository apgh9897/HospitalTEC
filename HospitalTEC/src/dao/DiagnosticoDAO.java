...
public class DiagnosticoDAO extends ConexionMySQL {
	 /**
	    ...
	    * @return
	    */
	   public String consultarDiagnosticoRangoFechas(int pCedula,String pFechaPiso, String pFechaTecho){
	       String consulta="";
		   PreparedStatement ps = null;
	       ResultSet rs=null;
	       Connection con = (Connection) conectar();
	    ...
	    * @return
	    */
	   public String consultarDiagnosticoPorNivel(int pCedula,String pNivel){
		   String consulta="";
		   PreparedStatement ps = null;
	       ResultSet rs=null;
	       Connection con = (Connection) conectar();
	    ...
	    * @return
	    */
	   public String consultarDiagnosticoPorNombre(int pCedula,String pNombreDiagnostico){
		   String consulta="";
		   PreparedStatement ps = null;
	       ResultSet rs=null;
	       Connection con = (Connection) conectar();
	    ...
	    * @return
	    */
	   public String consultarCantidadDiagnosticosPorPaciente(int pCedulaPaciente){
	       String consulta="";
		   PreparedStatement ps = null;
	       ResultSet rs=null;
	       Connection con = (Connection) conectar();
