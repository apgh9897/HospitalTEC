...
public class TratamientoDAO extends ConexionMySQL {
    ...
    * @return
    */
   public String consultarTratamientoRangoFechas(int pCedula,String pFechaPiso, String pFechaTecho){
       String consulta="";
	   PreparedStatement ps = null;
       ResultSet rs=null;
       Connection con = (Connection) conectar();
    ...
    * @return
    */
   public String consultarTratamientoPorTipo(int pCedula,String pTipoTratamiento){
       String consulta="";
	   PreparedStatement ps = null;
       ResultSet rs=null;
       Connection con = (Connection) conectar();
    ...
    * @return
    */
   public String consultarTratamientoPorNombre(int pCedula,String pNombreTratamiento){
       String consulta="";
	   PreparedStatement ps = null;
       ResultSet rs=null;
       Connection con = (Connection) conectar();
    ...
    * @return
    */
   public String consultarCantidadTratamientoPorPaciente(int pCedulaPaciente){
       String consulta="";
	   PreparedStatement ps = null;
       ResultSet rs=null;
       Connection con = (Connection) conectar();
